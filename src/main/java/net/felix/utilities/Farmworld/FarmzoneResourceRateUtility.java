package net.felix.utilities.Farmworld;
...
public final class FarmzoneResourceRateUtility {
    ...
    public static Component appendRateToScoreboardLine(Component lineText) {
        if (lineText == null) {
            return Component.empty();
        }

        MutableComponent result = lineText.copy();
        result.append(Component.literal(" -> " + MaterialRateUtility.formatRate(perMinute))
