...
public class NpcAlertsDetailScreen extends Screen {
    ...
    private void renderSettingsBox(DrawContext context, int mouseX, int mouseY) {
        ...
        context.drawStrokedRectangle(backgroundCheckboxX, backgroundCheckboxYPos, backgroundCheckboxSize, backgroundCheckboxSize, 0xFFFFFFFF);
        ...
        context.drawStrokedRectangle(screenMessageCheckboxX, screenMessageCheckboxY, screenMessageCheckboxSize, screenMessageCheckboxSize, 0xFFFFFFFF);
        
        if (showScreenMessage) {
            int checkX = screenMessageCheckboxX + 2;
            int checkY = screenMessageCheckboxY + 2;
            int checkSize = screenMessageCheckboxSize - 4;
            for (int i = 0; i < checkSize / 2; i++) {
                int px = checkX + i;
                int py = checkY + checkSize / 2 + i;
                if (px < screenMessageCheckboxX + screenMessageCheckboxSize - 2 && py < screenMessageCheckboxY + screenMessageCheckboxSize - 2) {
                    context.fill(px, py, px + 1, py + 1, 0xFFFFFFFF);
                }
            }
            for (int i = 0; i < checkSize / 2; i++) {
                int px = checkX + checkSize / 2 + i;
                int py = checkY + checkSize - 2 - i;
                if (px < screenMessageCheckboxX + screenMessageCheckboxSize - 2 && py >= screenMessageCheckboxY + 2) {
                    context.fill(px, py, px + 1, py + 1, 0xFFFFFFFF);
                }
            }
        }
        ...
        context.drawStrokedRectangle(screenMessageCheckboxX, screenMessageWhenDisabledCheckboxY,
        ...
        if (supportsPercent) {
            ...
            if (isMachtkristalleKey()) {
                ...
                context.drawStrokedRectangle(checkboxX, levelCheckboxY, checkboxSize, checkboxSize, 0xFFFFFFFF);
            ...
            if ("forschung".equals(configKey)) {
                ...
                context.drawStrokedRectangle(fieldX, inputY, inputWidth, inputHeight,
        ...
        if (hasIconOption) {
            ...
            context.drawStrokedRectangle(iconButtonX, iconButtonY, iconButtonWidth, iconButtonHeight, iconButtonColor);
        ...
        context.drawStrokedRectangle(colorButtonX, colorButtonY, colorButtonWidth, colorButtonHeight, 0xFFFFFFFF);
        ...
        context.drawStrokedRectangle(buttonX, buttonY, buttonWidth, buttonHeight, buttonColor);
        ...
        if (configKey.equals("machtkristalle")) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                context.drawStrokedRectangle(mkCheckboxX, mkSlotY, mkCheckboxSize, mkCheckboxSize, 0xFFFFFFFF);
            ...
            if (hasSeparateOverlayForMk) {
                for (int i = 0; i < 3; i++) {
                    ...
                    context.drawStrokedRectangle(mkCheckboxX, mkCheckboxY, mkCheckboxSize, mkCheckboxSize, 0xFFFFFFFF);
        ...
        if (configKey.equals("recycler") || configKey.equals("recyclerSlot1") || configKey.equals("recyclerSlot2") || configKey.equals("recyclerSlot3")) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                context.drawStrokedRectangle(recyclerCheckboxX, recyclerSlotY, recyclerCheckboxSize, recyclerCheckboxSize, 0xFFFFFFFF);
            ...
            if (hasSeparateOverlayForRecycler) {
                for (int i = 0; i < 3; i++) {
                    ...
                    context.drawStrokedRectangle(recyclerCheckboxX, recyclerCheckboxY, recyclerCheckboxSize, recyclerCheckboxSize, 0xFFFFFFFF);
        ...
        boolean isHoveringScreenMessageText = mouseX >= screenMessageTextX && mouseX <= screenMessageTextX + screenMessageTextWidth &&
                                             mouseY >= screenMessageCheckboxY && mouseY <= screenMessageCheckboxY + screenMessageTextHeight;
        if (isHoveringScreenMessageCheckbox || isHoveringScreenMessageText) {
            int hoverStartX = screenMessageCheckboxX - 2;
            int hoverEndX = screenMessageTextX + screenMessageTextWidth + 2;
        ...
        if (configKey.equals("machtkristalle")) {
            // Calculate positions (same as rendering section)
            int mkHoverCheckboxStartY = buttonY + buttonHeight + 10;
            int mkHoverCheckboxSize = 10;
            int mkHoverCheckboxX = boxX + 10;
            int mkHoverCheckboxSpacing = 20;
            ...
            for (int i = 0; i < 3; i++) {
                ...
                if (isHoveringMkSlotCheckbox || isHoveringMkSlotText) {
                    int hoverStartX = mkHoverCheckboxX - 2;
                    int hoverEndX = mkSlotTextX + mkSlotTextWidth + 2;
                    context.fill(hoverStartX, mkSlotY - 1, hoverEndX, mkSlotY + mkHoverCheckboxSize + 1, 0x40FFFFFF);
                }
            }
            ...
            if (getSeparateOverlay()) {
                for (int i = 0; i < 3; i++) {
                    ...
                    if (isHoveringMkSlotCheckbox || isHoveringMkSlotText) {
                        int hoverStartX = mkHoverCheckboxX - 2;
                        int hoverEndX = mkSlotTextX + mkSlotTextWidth + 2;
                        context.fill(hoverStartX, mkCheckboxY - 1, hoverEndX, mkCheckboxY + mkHoverCheckboxSize + 1, 0x40FFFFFF);
                    }
                }
            }
        }
    ...
    private boolean handleSettingsClick(double mouseX, double mouseY, int button) {
        ...
        boolean clickedOnScreenMessageCheckbox = (mouseX >= screenMessageCheckboxX && mouseX <= screenMessageCheckboxX + screenMessageCheckboxSize &&
                                                  mouseY >= screenMessageCheckboxY && mouseY <= screenMessageCheckboxY + screenMessageCheckboxSize);
        boolean clickedOnScreenMessageText = (mouseX >= screenMessageTextX && mouseX <= screenMessageTextX + screenMessageTextWidth &&
                                              mouseY >= screenMessageCheckboxY && mouseY <= screenMessageCheckboxY + screenMessageTextHeight);
        
        if (clickedOnScreenMessageCheckbox || clickedOnScreenMessageText) {
            boolean newValue = !getShowScreenMessage();
            setShowScreenMessage(newValue);
            CCLiveUtilitiesConfig.HANDLER.save();
            return true;
        }
    ...
    private boolean getShowScreenMessage() {
        switch (configKey) {
            case "forschung":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsForschungScreenMessage;
            case "amboss":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsAmbossScreenMessage;
            case "schmelzofen":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsSchmelzofenScreenMessage;
            case "jaeger":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsJaegerScreenMessage;
            case "komboKiste":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsKomboKisteScreenMessage;
            case "seelen":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsSeelenScreenMessage;
            case "essenzen":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsEssenzenScreenMessage;
            case "machtkristalle":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsMachtkristalleScreenMessage;
            case "recycler":
            case "recyclerSlot1":
            case "recyclerSlot2":
            case "recyclerSlot3":
                return CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerScreenMessage;
            default:
                return false;
        }
    }
    
    private void setShowScreenMessage(boolean value) {
        switch (configKey) {
            case "forschung":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsForschungScreenMessage = value;
                break;
            case "amboss":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsAmbossScreenMessage = value;
                break;
            case "schmelzofen":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsSchmelzofenScreenMessage = value;
                break;
            case "jaeger":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsJaegerScreenMessage = value;
                break;
            case "komboKiste":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsKomboKisteScreenMessage = value;
                break;
            case "seelen":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsSeelenScreenMessage = value;
                break;
            case "essenzen":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsEssenzenScreenMessage = value;
                break;
            case "machtkristalle":
                CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsMachtkristalleScreenMessage = value;
                break;
            case "recycler":
            case "recyclerSlot1":
            case "recyclerSlot2":
        ...
        if (isTextColor) {
            switch (configKey) {
                ...
                case "recycler":
                    ...
                    setter = (val) -> {
                        ...
                        CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot1TextColor = val;
                        CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot2TextColor = val;
                        CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot3TextColor = val;
                    };
                    break;
                case "recyclerSlot1":
                    getter = () -> CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot1TextColor;
            ...
            switch (configKey) {
                ...
                case "recycler":
                    ...
                    setter = (val) -> {
                        // Setze alle drei Slots gleichzeitig
                        CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot1PercentColor = val;
                        CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot2PercentColor = val;
                        CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot3PercentColor = val;
                    };
                    break;
                case "recyclerSlot1":
                    getter = () -> CCLiveUtilitiesConfig.HANDLER.instance().npcAlertsRecyclerSlot1PercentColor;
    ...
    public void close() {
        ...
        while (currentParent != null) {
            if (currentParent instanceof OverlayEditorScreen) {
                ...
                break;
            } else if (currentParent instanceof net.felix.utilities.Overall.NpcAlerts.NpcAlertsSettingsScreen) {
                ...
                try {
                    java.lang.reflect.Field parentField = net.felix.utilities.Overall.NpcAlerts.NpcAlertsSettingsScreen.class.getDeclaredField("parent");
