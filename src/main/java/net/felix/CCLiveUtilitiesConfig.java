    ...
    public static Screen createConfigScreen(Screen parent) {
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.literal("Aspekt X Position (vom rechten Rand)"))
                                        .description(OptionDescription.of(Text.literal("Horizontale Position des Aspekt Overlays (Pixel vom rechten Bildschirmrand)")))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.literal("Aspekt Y Position (vom oberen Rand)"))
                                        .description(OptionDescription.of(Text.literal("Vertikale Position des Aspekt Overlays (Pixel vom oberen Bildschirmrand)")))
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.literal("Karten X Position"))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.literal("Karten Y Position"))
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.literal("Statuen X Position"))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.literal("Statuen Y Position"))
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .tooltip(Text.literal("Einstellungen für den Drag-and-Drop Overlay Editor"))
                        .option(Option.<Boolean>createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                ...
                                .description(OptionDescription.of(Text.literal("Overlay Editor anzeigen oder ausblenden")))
